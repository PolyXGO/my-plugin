...
class Mp_Template extends MyPluginTemplate {
	/**
	 ...
	 */
	public static function asset_link( $asset, $prefix = 'MP' ) {
		$none_cache=(Mp_Functions_Common::is_localhost()==true)?'&date='.time():'';
		//$this->isLocalhost
		return constant( $prefix . '_URL' ) . '/view/assets/' . $asset . '?v=' . constant( $prefix . '_VERSION' ).$none_cache;
	}
